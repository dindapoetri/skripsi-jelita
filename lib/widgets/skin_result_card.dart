            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  spacing: 6,
                  runSpacing: 6,
                  children: result.idealIngredients
                      .map(
                        (item) => Chip(
                      label: Text(
                        capitalizeWords(item),
                        style: const TextStyle(fontSize: 10), // Font diperkecil
                      ),
                      padding: EdgeInsets.zero,
                      materialTapTargetSize: MaterialTapTargetSize.shrinkWrap, // Hilangkan padding tambahan
                      visualDensity: const VisualDensity(horizontal: -4, vertical: -4), // Chip lebih kecil/padat
