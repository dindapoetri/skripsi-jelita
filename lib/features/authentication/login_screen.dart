...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      // AKTIF: Menggunakan Supabase Auth
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () => Navigator.of(context).pushNamed(AppRoutes.forgotPassword), // ← ganti ini
                      child: const Text('Ganti', style: TextStyle(color: AppTheme.primary, fontWeight: FontWeight.bold)),
                    ),
                  ],
                ),
              ],
